...
namespace simlitekkes.UserControls.OperatorPenelitianPusdik
{
    public partial class monitoringMonevEksternal : System.Web.UI.UserControl
    {
        ...
        Models.OperatorPenelitianPusdik.monitoringMonevEksternal modelHasilMonevEksternal = new Models.OperatorPenelitianPusdik.monitoringMonevEksternal();
        ...
        {
            if (!modelHasilMonevEksternal.getJmlData(ddlThnPelaksanaan.SelectedValue,
                tbCariPT.Text, 0, 0))
            ...
            if (modelHasilMonevEksternal.listData(ref dt, ddlThnPelaksanaan.SelectedValue,
                tbCariPT.Text, int.Parse(ddlJmlBaris.SelectedValue), offset))
            {
        ...
        protected void lbCariPT_Click(object sender, EventArgs e)
        {
            isiGvData(int.Parse(ddlJmlBaris.SelectedValue), 0);
        }
        ...
        protected void lbUnduhExcel_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage pck = new ExcelPackage())
            {
                ...
                if (modelHasilMonevEksternal.getExcel(ref dt, ddlThnPelaksanaan.SelectedValue))
                {
        ...
        protected void pagingData_PageChanging(object sender, EventArgs e)
        {
            ...
            if (modelHasilMonevEksternal.listData(ref dt, ddlThnPelaksanaan.SelectedValue, tbCariPT.Text, 
