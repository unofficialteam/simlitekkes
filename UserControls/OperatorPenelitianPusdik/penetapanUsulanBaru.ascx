<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="penetapanUsulanBaru.ascx.cs" Inherits="simlitekkes.UserControls.OperatorPenelitianPusdik.penetapanUsulanBaru" %>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <asp:RadioButtonList ID="rblProgramHibah" runat="server" RepeatDirection="Horizontal"
                                ...
                                <asp:ListItem Text="Desentralisasi" Value="1" Selected="True" />
                                <asp:ListItem Text="Penugasan" Value="6" />
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    | Skema:
                            <asp:Label Font-Bold="true" ID="lblNamaSkemaRekapPT" runat="server"></asp:Label><br />
                    Tahapan:
                            <asp:Label runat="server" ID="lblTahapanRekapPT" Font-Bold="true"></asp:Label>
                </div>
                <div class="col-md-4 text-right">
                    Tahun Usulan:
                            <asp:Label runat="server" ID="lblThnUsulanRekapPT" Font-Bold="true"></asp:Label>
                    | Pelaksanaan:
                            <asp:Label runat="server" ID="lblThnPelaksanaanRekapPT" Text="" Font-Bold="true"></asp:Label><br />
