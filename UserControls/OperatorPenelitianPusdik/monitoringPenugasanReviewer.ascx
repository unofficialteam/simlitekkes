<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="monitoringPenugasanReviewer.ascx.cs" Inherits="simlitekkes.UserControls.OperatorPenelitianPusdik.monitoringPenugasanReviewer" %>
