<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="monitoringLaporanAkhirTahun.ascx.cs" Inherits="simlitekkes.UserControls.OperatorPenelitianPusdik.monitoringLaporanAkhirTahun" %>
...
<asp:MultiView runat="server" ID="mvMain">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12" style="margin-top: 0px; color: #313233e3;">
                    <h4>Monitoring Laporan Akhir Tahun</h4>
                </div>
                <div class="col-md-5">
    ...
    <asp:View runat="server" ID="vDaftarLapAkhirThn">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8">
                    Skema:       
                    <asp:Label Font-Bold="true" ID="lblNamaSkemaDaftarLapAkhirThn" runat="server"></asp:Label><br />
                    Tahun Pendanaan:        
                    <asp:Label runat="server" ID="lblThnPelaksanaanDaftarLapAkhirThn" Text="" Font-Bold="true"></asp:Label>
                </div>
                <div class="col-md-4 text-right">
                    <asp:LinkButton ID="lbKembaliDaftarLapAkhirThn" runat="server" CssClass="btn btn-info"
                        OnClick="lbKembaliDaftarLapAkhirThn_Click">Kembali</asp:LinkButton>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <asp:TextBox runat="server" ID="tbPencarianDaftarLapAkhirThn" CssClass="form-control" placeholder="Nama Peneliti"></asp:TextBox>
                                    <div class="input-group-append">
                                        <asp:LinkButton runat="server" ID="lbPencarianDaftarLapAkhirThn" CssClass="btn btn-outline-info"
                                            OnClick="lbPencarianDaftarLapAkhirThn_Click"><i class="fas fa-search"></i></asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-inline" style="color: #7cab3f; float: right">
                                Jml. Baris:&nbsp;        
                                <label for="ddlJmlBarisDaftarLapAkhirThn"></label>
                                <asp:DropDownList ID="ddlJmlBarisDaftarLapAkhirThn"
                                    OnSelectedIndexChanged="ddlJmlBarisDaftarLapAkhirThn_SelectedIndexChanged" runat="server" AutoPostBack="True"
                                ...
                                &nbsp;&nbsp;
                                <asp:LinkButton runat="server" ID="lbExcelDaftarLapAkhirThn"
                                    ToolTip="Export Excel" ForeColor="Green" OnClick="lbExcelDaftarLapAkhirThn_Click">        
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-hover table-striped mb-4">
                                    ...
                                    <tbody>
                                        <asp:ListView ID="lvDaftarLapAkhirThn" runat="server"
                                            DataKeyNames="id_usulan_kegiatan, id_transaksi_kegiatan, kd_sts_pelaksanaan"
                                            OnItemDataBound="lvDaftarLapAkhirThn_ItemDataBound"
                                            OnItemCommand="lvDaftarLapAkhirThn_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:LinkButton runat="server" ID="lbUnduhLaporanAkhirThn" CommandName="unduhLaporanAkhirThn"
                            ...
                            <asc:controlPaging runat="server" ID="pagingDaftarLapAkhirThn" OnPageChanging="pagingDaftarLapAkhirThn_PageChanging" />
                        </div>
                    </div>
                </div>
            </div>
