<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="monitoringMonevEksternal.ascx.cs" Inherits="simlitekkes.UserControls.OperatorPenelitianPusdik.monitoringMonevEksternal" %>
            ...
            <div class="form-inline p-t-5">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <asp:TextBox runat="server" ID="tbCariPT" CssClass="form-control" placeholder="Nama Perguruan Tinggi"></asp:TextBox>
                        <div class="input-group-append">
                            <asp:LinkButton runat="server" ID="lbCariPT" OnClick="lbCariPT_Click" CssClass="btn btn-outline-info"><i class="fas fa-search"></i></asp:LinkButton>
                        </div>
                    </div>
                </div>
                &nbsp;&nbsp;
