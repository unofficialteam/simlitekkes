<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="monitoringPlottingReviewer.ascx.cs" Inherits="simlitekkes.UserControls.OperatorPenelitianPusdik.monitoringPlottingReviewer" %>
