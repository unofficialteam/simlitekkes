...
{
    public partial class monitoringPenugasanReviewer : System.Web.UI.UserControl
    {
        ...
        protected void gvMonitoringPenugasanReviewer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else
            {
                if (ViewState["kdproghibah"].ToString() == "1")
                    lblProgramKegiatan.Text = "Penelitian Desentralisasi";
                else
                    lblProgramKegiatan.Text = "Penelitian Penugasan";
