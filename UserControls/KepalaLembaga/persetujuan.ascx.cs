...
namespace simlitekkes.UserControls.KepalaLembaga
{
    public partial class persetujuan : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.GetCurrent(this.Page).RegisterPostBackControl(this.lbdesentralisasi);
            ScriptManager.GetCurrent(this.Page).RegisterPostBackControl(this.lbPenugasan);
