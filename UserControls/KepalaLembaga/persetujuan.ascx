<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="persetujuan.ascx.cs" Inherits="simlitekkes.UserControls.KepalaLembaga.persetujuan" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main-header" style="margin-top: 0px; color: #313233e3;">
                    <h4 style="font-family: Tahoma">Usulan Baru Kegiatan Penelitian</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="margin: 10px 0px;">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="form-inline text-right" style="color: #7cab3f;">
                            Jml. Baris&nbsp;
                        <asp:DropDownList ID="ddlJmlBaris" runat="server" AutoPostBack="true" ClientIDMode="Static" Enabled="true" OnSelectedIndexChanged="ddlJmlBaris_SelectedIndexChanged" Width="100px">
