<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="dokumenPendukungReviewerPPM.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.pendaftaranReviewer.dokumenPendukungReviewerPPM" %>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <div class="col-sm-6">
                                        <asp:Label runat="server" ID="lblJudulPendaftaran" Style="color: orangered; font-size: x-large;">Pendaftaran Reviewer Nasional (PPM)</asp:Label>
                                    </div>
                                    <div class="col-sm-6">
