<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pendaftaranReviewer.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.pendaftaranReviewer.pendaftaranReviewer" %>
<%@ Register Src="~/UserControls/Pengusul/pendaftaranReviewer/persyaratanUmumReviewerPenelitian.ascx" TagPrefix="uc" TagName="ktSyaratUmumRevPenelitian" %>
<%@ Register Src="~/UserControls/Pengusul/pendaftaranReviewer/dokumenPendukungReviewerPenelitian.ascx" TagPrefix="uc" TagName="dokumenPendukung" %>
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="text-left" style="font-size: 24px;">
                                <asp:Label runat="server" ID="lblJudulForm" Text="Pendaftaran Reviewer Penelitian"></asp:Label>
                            </div>
                        </div>
                        ...
                        <asp:View runat="server" ID="vKaryaSeniMonumental">
                            ...
                            <div class="row">
                                <div class="col-lg-12" style="text-align: right;">
                                    <asp:LinkButton runat="server" ID="lbKembali" CssClass="btn btn-info" OnClick="lbKembali_Click1">
                                            Kembali
                                    </asp:LinkButton>
                                </div>
                            </div>
                                    ...
                                    <ContentTemplate>
                                                        ...
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td style="vertical-align: middle;">
                                                                    <asp:LinkButton runat="server" ID="lbHapusKepakaran" CssClass="btn btn-outline-warning btn-mini" 
                                                                        OnClick="lbHapusKepakaran_Click" Visible="false">
                                                            Hapus semua
                                                                    </asp:LinkButton>
                                                                </td>
                                                            </tr>
                                        ...
                                        Daftar
                                                        ...
                                                        <asp:Label runat="server" ID="lblDaftar" CssClass="btn btn-disabled disabled" Visible="false" 
                                                            Style="margin-top: 20px;" ToolTip="Bukan dalam jadwal pendaftaran/eligibilitas sebagai reviewer belum terpenuhi.">
                                        Daftar
                                                        </asp:Label>
                                                    </div>
                                                </div>
