<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="usulanBaru.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.usulanBaru" %>

<%--<%@ Register Src="~/UserControls/Pengusul/dokumenUsulan.ascx" TagPrefix="uc" TagName="dokUsulan" %>--%>
<%@ Register Src="~/UserControls/Pengusul/dokumenUsulan2019.ascx" TagPrefix="uc" TagName="dokUsulan" %>
<%@ Register Src="~/UserControls/Pengusul/persyaratanUmum.ascx" TagPrefix="uc" TagName="persyaratan" %>
<%@ Register Src="~/UserControls/Pengusul/IdentitasUsulan.ascx" TagPrefix="uc" TagName="IdentitasUsulan" %>
<%@ Register Src="~/UserControls/Pengusul/cvKetua.ascx" TagPrefix="uc" TagName="cvKetua" %>
<%@ Register Src="~/UserControls/Pengusul/anggotaPeneliti.ascx" TagPrefix="uc" TagName="anggotaPeneliti" %>
<%@ Register Src="~/UserControls/Pengusul/targetLuaran2019.ascx" TagPrefix="uc" TagName="ktLuaran" %>
<%@ Register Src="~/UserControls/Pengusul/listUsulanBaru.ascx" TagPrefix="uc" TagName="lstUsulanBaru" %>
...
<%@ Register Src="~/UserControls/Pengusul/dokumenWbs.ascx" TagName="dokumenWbs" TagPrefix="uc" %>
