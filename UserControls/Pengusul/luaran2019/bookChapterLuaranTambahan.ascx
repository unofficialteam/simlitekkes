<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="bookChapterLuaranTambahan.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaran2019.bookChapterLuaranTambahan" %>
<div class="row">
...
<div class="row">
    <div class="col-lg-4 text-right">
        Rencana Nama Penerbit<%--<br />
        <b style="color: red; font-size: x-small;"></b>--%>
    </div>
    <div class="col-lg-8 text-left">
...
<div class="row">
    <div class="col-lg-4 text-right">
        Bukti Luaran <span style="color: red;">(Tahun
            <asp:Label runat="server" ID="lblThnKe" Text=""></asp:Label>)</span>
    </div>
    <div class="col-lg-8 text-left">
