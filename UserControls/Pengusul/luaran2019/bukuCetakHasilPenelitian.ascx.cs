...
{
    public partial class bukuCetakHasilPenelitian : System.Web.UI.UserControl
    {
            ...
            string p_id_jenis_luaran = "", string kd_kategori_jenis_luaran = "")
        {
            ...
            if (p_id_jenis_luaran != "") // untuk update data
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    tbRencanaNamaPenerbit.Text = dt.Rows[0]["keterangan"].ToString();
                    ddlStatus.ClearSelection();
        ...
        protected void lbSimpan_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                noty.Notify(this.Page, uiNotify.NotifyType.error, "Terjadi Kesalahan",
                    "Simpan luaran buku cetak hasil penelitian gagal. Silakan hubungi administrator.");
            }
        }
