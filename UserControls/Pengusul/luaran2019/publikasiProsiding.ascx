<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="publikasiProsiding.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaran2019.publikasiProsiding" %>
...
<div class="row">
    <div class="col-lg-4 text-right">
        Rencana Nama Conference 2
    </div>
    <div class="col-lg-8 text-left">
       <asp:TextBox runat="server" ID="tbRencanaNamaKonferensi2" CssClass="form-control" placeholder="Nama Konferensi 2" Width="300"
           TextMode="MultiLine"></asp:TextBox>
    </div>
</div>
<br />
<div class="row">
    <div class="col-lg-4 text-right">
        Rencana Nama Conference 3
    </div>
    <div class="col-lg-8 text-left">
       <asp:TextBox runat="server" ID="tbRencanaNamaKonferensi3" CssClass="form-control" placeholder="Nama Konferensi 3" Width="300" 
           TextMode="MultiLine"></asp:TextBox>
    </div>
</div>
<br />
