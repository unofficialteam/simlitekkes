<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="bukuCetakHasilPenelitian.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaran2019.bukuCetakHasilPenelitian" %>
...
<div class="row">
    ...
    <div class="col-lg-8 text-left">
         <asp:TextBox runat="server" ID="tbRencanaNamaPenerbit" CssClass="form-control" Width="80%">
        </asp:TextBox>
    </div>
</div>
<br />
<div class="row">
    ...
    <div class="col-lg-8 text-left">
        <asp:DropDownList runat="server" ID="ddlStatus" CssClass="form-control" Width="300" AutoPostBack="true"
            ...
            <asp:ListItem Text="Terbit ber ISBN" Value="1"></asp:ListItem>
        </asp:DropDownList>
    </div>
</div>
<br />
