...
namespace simlitekkes.UserControls.Pengusul.luaran2019
{
    public partial class publikasiProsiding : System.Web.UI.UserControl
    {
        ...
        public void init(string kd_kategori_jenis_luaran, string id_usulan, string tahun_ke, int id_skema, string idKelompokLuaran)
        {
            ...
            tbRencanaNamaKonferensi2.Text = "";
            tbRencanaNamaKonferensi3.Text = "";
        ...
        {
            if (tbRencanaNamaKonferensi1.Text.Trim() == "" || tbRencanaNamaKonferensi2.Text.Trim() == "" ||
                tbRencanaNamaKonferensi3.Text.Trim()=="")
            {
            ...
            string[] arrRencanaNamaProsiding  = new string[] { tbRencanaNamaKonferensi1.Text, tbRencanaNamaKonferensi2.Text, tbRencanaNamaKonferensi3.Text };
