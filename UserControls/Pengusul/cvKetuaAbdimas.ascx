<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="cvKetuaAbdimas.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.cvKetuaAbdimas" %>
...
<%@ Register Src="~/UserControls/Pengusul/riwayatPengabdian.ascx" TagPrefix="uc" TagName="pengabdian" %>
...
<asp:UpdatePanel ID="upPersyaratanUmum" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:MultiView ID="mvcvKetua" runat="server" ActiveViewIndex="0">
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h5>Identitas Pengusul-Ketua</h5>
                                </div>
                                <div class="card-body">
                                    <div>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h5>Skema Pengabdian Kepada Masyarakat Perguruan Tinggi Klaster&nbsp;<asp:Label ID="lblKlaster" runat="server" Text=""></asp:Label>
                                    </h5>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <asp:ListView ID="lvRekamJejak" runat="server"
                                        ...
                                        OnItemDataBound="lvRekamJejak_ItemDataBound">
                                        <LayoutTemplate>
                                            <table class="table table-hover">
                                                <tbody>
                                                    <tr>
            ...
            <asp:View ID="vPengabdian" runat="server">
                <uc:pengabdian runat="server" ID="riwayatPengabdian" />
                <div>
                    <asp:LinkButton ID="lbKembaliPengabdian" runat="server" OnClick="lbKembaliPengabdian_Click"
