<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="listUsulanLanjutan.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.listUsulanLanjutan" %>
<asp:ScriptManagerProxy ID="smpListUsulanLanjutan" runat="server"></asp:ScriptManagerProxy>
                                            ...
                                            <EmptyDataTemplate>
                                                ...
                                                <%--<div class="col-sm-12">
                                                    <div class="alert alert-light" role="alert">
                                                        <p class="text-primary">Belum ada data Usulan lanjutan...</p>
                                                    </div>
                                                </div>--%>
                                            </EmptyDataTemplate>
                                        </asp:ListView>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><asp:RadioButtonList runat="server" ID="rblSkemaPasca" Visible="false">
                    <%--<asp:ListItem Text="Penelitian Tesis Magister" Value ="76"></asp:ListItem>--%>
