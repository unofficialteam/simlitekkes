...
{
    public partial class persyaratanUmum : System.Web.UI.UserControl
    {
        ...
        public int isiDataPersyaratanUmum(string thnUsulan, string thnPelaksanaan)
        {
            ...
            string thn_pelaksanaan_kegiatan = thnPelaksanaan; // ddlThnPelaksanaanKegiatan.SelectedValue;
            ...
            if (objBerandaPengusul.getPersonal(ref dtPersonal, id_personal))
            {
                if (dtPersonal.Rows.Count > 0)
                {
                    ...
                    lblKelompokBidang.Text = dtPersonal.Rows[0]["kategori_program_studi"].ToString();
                }
            }
