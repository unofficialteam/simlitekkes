<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rabRevisiAbdimas.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.perbaikanProposalAbdimas.rabRevisiAbdimas" %>
<style>
    .equal {
        display: flex;
        display: -webkit-flex;
                            ...
                            <asp:Label ID="lblTotalDanaDiajukan" runat="server" Font-Bold="true">0</asp:Label>
                                ...
                                <div class="row">
                                    <div class="offset-sm-10 col-sm-2 text-right">
                                        <label class="p-l-15 p-r-15 p-t-5 p-b-5 font-weight-bold grandtotal"
                                            style="display: inline-block; color: white; background-color: #323232;">
