<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rekapLuaran.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.rekapLuaran" %>
                        ...
                        <asp:View runat="server" ID="vDaftarUsulanLuaran">
                            <div class="row">
                                <div class="alert alert-warning alert-dismissible">
                                    ...
                                    <h4 style="color:black"><i class="icon fa fa-info">&nbsp;</i>Info Luaran Wajib dan Tambahan Tahun 2019</h4>
                                    <p style="color:black">
                                    ...
                                    <asp:GridView runat="server" ID="gvLuaranDicapai" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Jumlah Luaran Wajib">
                                                <ItemTemplate>
                                                    <div>
                                                        <asp:LinkButton ID="lbLuaranWajib" runat="server" CommandArgument="<%# Container.DataItemIndex %>"
                                                            CommandName="ubah_luaran_wajib" CssClass="btn btn-primary btn-sm" Font-Size="Larger" ToolTip="Lengkapi" Text='<%# Eval("jml_luaran_wajib") %>'></asp:LinkButton>
                                                    </div>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Jumlah Luaran Tambahan">
                                                <ItemTemplate>
                                                    <div style="margin-top: 5px;">
                                                        <asp:LinkButton ID="lbLuaranTambahan" runat="server" CommandArgument="<%# Container.DataItemIndex %>"
                                                            CommandName="ubah_luaran_tambahan" CssClass="btn btn-primary btn-sm" Font-Size="Larger" ToolTip="Lengkapi" Text='<%# Eval("jml_luaran_tambahan") %>'></asp:LinkButton>
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" Width="80px" />
                                                <ItemStyle HorizontalAlign="Center" />
