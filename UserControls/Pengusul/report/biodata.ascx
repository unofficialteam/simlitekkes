<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="biodata.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.report.biodata" %>
<style>
    /*
table{
...
<table>
    <tr>
        <td style="font-family: Arial; font-size: 12px; font-weight: bold;">LAMPIRAN 1. BIODATA PENGUSUL
        </td>
    </tr>
    <tr>
        <td style="font-family: Arial; font-size: 12px; font-weight: bold;">A. BIODATA KETUA PENGUSUL
        </td>
    </tr>
</table>
...
<table width="100%" class="trtd_left">
    <tr>
        <td class="trtd_left" style="width: 100px;">Nama
        </td>
        <td class="trtd_left">
    ...
    <tr>
        <td class="trtd_left">NIDN/NIDK
        </td>
        <td class="trtd_left">
            <asp:Label runat="server" ID="lblNidn"></asp:Label>
        </td>
        <tr>
            <td class="trtd_left">Pangkat/Jabatan
            </td>
...
<table>
    ...
    <tr>
        <td style="font-family: Arial; font-size: 12px; font-weight: bold;">Prosiding seminar/konverensi internasional terindeks
        </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td style="font-family: Arial; font-size: 12px; font-weight: bold;">Buku
        </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td style="font-family: Arial; font-size: 12px; font-weight: bold;">Perolehan KI
        </td>
    </tr>
</table>
...
<asp:Panel runat="server" ID="pnlRiwayatAbdimas">
    ...
    <table>
        <tr>
            <td style="font-family: Arial; font-size: 12px; font-weight: bold;" class="auto-style1">Riwayat Pengabdian Kepada Masyarakat
            </td>
        </tr>
    </table>
    <table width="100%" class="trtd">
...
<asp:Panel runat="server" ID="panelRiwayatPenelitian">
    <div>&nbsp;</div>
    <table>
        <tr>
            <td style="font-family: Arial; font-size: 12px; font-weight: bold;">Riwayat penelitian didanai Kemenristekdikti
            </td>
        </tr>
    </table>
    <table width="100%" class="trtd">
        <tr align="center" class="trtd">
            ...
            <td width="400px" class="trtd">Judul
            </td>
            <td width="100px" class="trtd">Tahun
            </td>
            <td width="40px" class="trtd">Dana Disetujui
            </td>
        </tr>
        <asp:Repeater ID="rptRiwayatPenelitian" runat="server" OnItemDataBound="rptKI_ItemDataBound">
            <ItemTemplate>
                <tr class="trtd">
                    <td class="trtd">
                        <%# Container.ItemIndex + 1 %>
                    ...
                    <td class="trtd">
                        <%# Eval("thn_usulan_kegiatan")%>-<%# Eval("thn_pelaksanaan_kegiatan")%></td>
                    <td class="trtd_right" style="word-wrap: break-word;">
                        <%# Eval("dana_disetujui",  "{0:0,00}")  %>
                    </td>
                </tr>
