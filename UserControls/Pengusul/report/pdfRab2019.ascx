<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pdfRab2019.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.report.pdfRab2019" %>
...
<table>
    ...
    <tr>
        <td  style="font-family: Arial; font-size: 12px;">
            Rencana anggaran biaya penelitian mengacu pada PMK yang berlaku dengan besaran minimum dan maksimum sebagaimana diatur pada buku Pedoman Penelitian dan Pengabdian kepada Masyarakat Politeknik Kesehatan Kementerian Kesehatan Edisi II.
        </td>
    </tr>
    <tr>
...
<asp:ListView ID="lvRABTahun1" runat="server" OnItemDataBound="lvRABTahun1_ItemDataBound">
    ...
    <ItemTemplate>
        <tr>
            ...
            <td class="trtd_right"><%# Eval("total_harga","{0:0,00}")%></td>
