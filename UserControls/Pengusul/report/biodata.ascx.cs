...
{
    public partial class biodata : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //if (Session["idPersonalKetua"] != null)
            if(Request.QueryString.Get("id_personal") != null)
            {
                isiBioDataKetua(Request.QueryString.Get("id_personal").ToString());
                //Session.Remove("idPersonalKetua");
            }
        }
        ...
        public void isiBioDataKetua(string idPersonal)
        {
            ...
            panelRiwayatPenelitian.Visible = false;
            ...
            //else
            //{
            //    panelRiwayatPenelitian.Visible = true;
            //    isiRiwayatPenelitian(idPersonal);
            //}
        }
        ...
        void isiRiwayatPenelitian(string idPersonal)
        {
            DataTable dt = new DataTable();
            mdlPdfBaru.GetRiwayatPeenelitianDidanai(ref dt, idPersonal);
            rptRiwayatPenelitian.DataSource = dt;
            rptRiwayatPenelitian.DataBind();
        }
