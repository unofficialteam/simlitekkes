...
{
    public partial class hakCipta : System.Web.UI.UserControl
    {
        ...
        simlitekkes.Models.pelaksanaan.hakCipta mdlHakCipta = new simlitekkes.Models.pelaksanaan.hakCipta();
        ...
        private void initData(int idTargetJenisLuaran, bool pilih = false)
        {
            ...
            clearTextBox();
            if (ddlStatusHakCipta.SelectedValue == "50" || 
                ddlStatusHakCipta.SelectedValue == "51") // Status Dalam proses pengajuan dan Bersertifikat
            {
                if (dt.Rows.Count > 0)
                {
        ...
        {
            DataTable dt = new DataTable();
            mdlHakCipta.getDataTargetLuaranHakCipta(ref dt, id_target_luaran);
            if (dt.Rows.Count > 0)
            {
                tbNamaCiptaan.Text = dt.Rows[0]["nama_ciptaan"].ToString();
                tbPemegangHakCipta.Text = dt.Rows[0]["pemegang_hak_cipta"].ToString();
        ...
        private void showHidePanel()
        {
            ...
            if (ddlStatusHakCipta.SelectedValue == "51") // Status Bersertifikat
            {
            ...
            else if (ddlStatusHakCipta.SelectedValue == "50") // Status Dalam proses pengajuan
            {
        ...
        protected void lbSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (tbNamaCiptaan.Text.Trim().Length == 0) emptyField.Add("Nama ciptaan");
            if (tbPemegangHakCipta.Text.Trim().Length == 0) emptyField.Add("Pemegang hak cipta");
            ...
            if (ddlStatusHakCipta.SelectedValue == "51") // Status Bersertifikat
            {
                ...
                if (tbNoPencatatanHakCipta.Text.Trim().Length == 0) emptyField.Add("No. Pencatatan hak cipta");
                    ...
                    int.Parse(ddlStatusHakCipta.SelectedValue)))
            {
                ...
                if (ddlStatusHakCipta.SelectedValue == "51") // Status Bersertifikat
                {
                    if (mdlHakCipta.insupTargetLuaranHakCipta(
                        int.Parse(ViewState["id_target_luaran"].ToString()),
