<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="merekDagang.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranLapKemajuan.merekDagang" %>
