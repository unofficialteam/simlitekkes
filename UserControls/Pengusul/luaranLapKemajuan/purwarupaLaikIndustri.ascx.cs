...
{
    public partial class purwarupaLaikIndustri : System.Web.UI.UserControl
    {
        ...
        luaranPurwarupaLaikIndustri mdlPurwarupa = new luaranPurwarupaLaikIndustri();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                isiDdlStatusTargetPurwarupaLaikIndustri();
            }
            ...
            string thnPelaksanaan, int idJenisLuaran, string kdTahapanKegiatan)
        {
            ...
            {
                isiDdlStatusTargetPurwarupaLaikIndustri();
                ddlStatusPurwarupaLaikIndustri.SelectedValue = dt.Rows[0]["id_target_jenis_luaran"].ToString();
                initData(int.Parse(dt.Rows[0]["id_target_jenis_luaran"].ToString()), true);
            }
            else
            {
                isiDdlStatusTargetPurwarupaLaikIndustri();
                initData(int.Parse(ddlStatusPurwarupaLaikIndustri.SelectedValue), false);
            }

            //initData(0);
            //isiDdlStatusTargetPurwarupaLaikIndustri();
            //initData(int.Parse(ddlStatusPurwarupaLaikIndustri.SelectedValue), false);
            showHidePanelPurwarupa();
        }

        protected void ddlStatusPurwarupaLaikIndustri_SelectedIndexChanged(object sender, EventArgs e)
        {
            initData(int.Parse(ddlStatusPurwarupaLaikIndustri.SelectedValue), true);
            showHidePanelPurwarupa();
            if (OnChildEvent != null)
                OnChildEvent(sender, null);
        }

        private void showHidePanelPurwarupa()
        {
            ...
            if (ddlStatusPurwarupaLaikIndustri.SelectedValue == "115")
            {
                lblPeriodeCoba.Visible = true;
                lblLinkVideoProduk.Visible = true;
            }
            if(ddlStatusPurwarupaLaikIndustri.SelectedValue == "116")
            {
            ...
            DataTable dt = new DataTable();
            mdlLapKemajuan.ListJenisDokumen(ref dt, int.Parse(ddlStatusPurwarupaLaikIndustri.SelectedValue));
        ...
        private void initData(int idTargetJenisLuaran, bool pilih = false)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                isiAtributPurwarupaLaikIndustri(int.Parse(dt.Rows[0]["id_target_luaran"].ToString()));
        ...
        private void isiAtributPurwarupaLaikIndustri(int id_target_luaran)
        {
            DataTable dt = new DataTable();
            mdlPurwarupa.getDataTargetLuaranPurwarupaLaikIndustri(ref dt, id_target_luaran);
            if (dt.Rows.Count > 0)
            {
                tbNamaPurwarupa.Text = dt.Rows[0]["nama_purwarupa_laik_industri"].ToString();
                tbPemegangPurwarupa.Text = dt.Rows[0]["pemegang_purwarupa_laik_industri"].ToString();
        ...
        private void isiDdlStatusTargetPurwarupaLaikIndustri()
        {
            DataTable dt = new DataTable();
            mdlLapKemajuan.ListTargetJenisLuaran(ref dt, 43); // purwarupa laik industri
            ddlStatusPurwarupaLaikIndustri.Items.Clear();
            ddlStatusPurwarupaLaikIndustri.DataSource = dt;
            ddlStatusPurwarupaLaikIndustri.DataBind();
        ...
        protected void lbSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (tbNamaPurwarupa.Text.Trim().Length == 0) emptyField.Add("Nama Purwarupa");
            if (tbPemegangPurwarupa.Text.Trim().Length == 0) emptyField.Add("Nama Purwarupa");
            ...
            int status = int.Parse(ddlStatusPurwarupaLaikIndustri.SelectedValue);
...

            {
                ...
                if (mdlPurwarupa.insupTargetLuaranPurwarupaLaikIndustri(
                    int.Parse(ViewState["id_target_luaran"].ToString()),
                    tbNamaPurwarupa.Text,
                    tbPemegangPurwarupa.Text,
                    tbTglAwal.Text,
                    tbTglAkhir.Text,
                    tbLinkVideo.Text
                    ))
        ...
        {
            tbNamaPurwarupa.Text = string.Empty;
            tbPemegangPurwarupa.Text = string.Empty;
