<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="konferensi.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranLapKemajuan.konferensi" %>
    ...
    <div class="col-lg-12">
        ...
        <div style="padding: 10px;">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbNamaKonferens" CssClass="form-control" placeholder="Nama conference"></asp:TextBox>
                </div>
            </div>
