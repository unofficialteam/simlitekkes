...
{
    public partial class desain : System.Web.UI.UserControl
    {
        ...
        const int ID_JENIS_LUARAN_DESAIN_PENERAPAN = 26;
            ...
            string thnPelaksanaan, int idTargetCapaianLuaran, string kdTahapanKegiatan)
        {
            ...
            mdlLapKemajuan.cekTargetLuaran(ref dt, idTransaksiKegiatan, idKelompokLuaran, ID_JENIS_LUARAN_DESAIN_PENERAPAN);
            if (dt.Rows.Count > 0)
            {
                isiDdlStatusDesain();
        ...
        {
            DataTable dt = new DataTable();
            mdlLapKemajuan.ListTargetJenisLuaranDesain(ref dt, ID_JENIS_LUARAN_DESAIN_PENERAPAN, IdTargetCapaianLuaran); // Desain
        ...
        private void clearTextBox()
        {
            ...
            tbTglAwalDiterapkan.Text = string.Empty;
        }
        ...
        private void isiAtributDesain(int id_target_luaran)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                tbTglAwalDiterapkan.Text = dt.Rows[0]["tgl_diterapkan"].ToString() != "" ?
                DateTime.Parse(dt.Rows[0]["tgl_diterapkan"].ToString()).ToString("yyyy-MM-dd") : "";
            }
            else
            {
                clearTextBox();
        ...
        {
            pnlTglAwalDiterapkan.Visible = false;
            if (ddlStatusDesain.SelectedValue == "28") //Telah diterapkan
            {
                pnlTglAwalDiterapkan.Visible = true;
            }
            DataTable dt = new DataTable();
        ...
        protected void lbSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (ddlStatusDesain.SelectedValue == "28") //Telah diterapkan
            {
                ...
                if (tbTglAwalDiterapkan.Text.Trim().Length == 0) emptyField.Add("Tanggal awal diterapkan");
           ...
           ))
            {
                ...
                if (int.Parse(ddlStatusDesain.SelectedValue) == 27)
                {
                    if (mdlDesain.insupTargetLuaranDesain(
                        int.Parse(ViewState["id_target_luaran"].ToString()),
                        tbNamaDesain.Text, tbPemegangDesain.Text,
                        tbLinkVideo.Text, "0001-01-01", int.Parse(ddlStatusDesain.SelectedValue)
                        ))
                    {
                ...
                else
                {
                    if (mdlDesain.insupTargetLuaranDesain(
                        int.Parse(ViewState["id_target_luaran"].ToString()),
                        tbNamaDesain.Text, tbPemegangDesain.Text,
                        tbLinkVideo.Text, tbTglAwalDiterapkan.Text, int.Parse(ddlStatusDesain.SelectedValue)
                        ))
                    {
                        noty.Notify(this.Page, uiNotify.NotifyType.success, "Informasi", "Simpan data berhasil.");
                    }
