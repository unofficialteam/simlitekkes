...
{
    public partial class visitingLecturer : System.Web.UI.UserControl
    {
        ...
        public void setData(string idTransaksiKegiatan, string idLuaranDijanjikan, string strJudulForm, int idKelompokLuaran, string thnPelaksanaan, int idJenisLuaran)
        {
        ...
        private void isiAtributJurnal(int id_target_luaran)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                tbLinkVideo.Text = dt.Rows[0]["url_video"].ToString();
            }
        }
        ...
        private void showHidePanelPublikasi(string idJenisLuaran)
        {
            ...
            if (ddlTargetJenisLuaranPublikasi.SelectedIndex == ddlTargetJenisLuaranPublikasi.Items.Count-1)
            {
        ...
        protected void lbSimpan_Click(object sender, EventArgs e)
        {
            ...
            dir = "~/fileUpload/laporan_kemajuan/BuktiLuaran";
