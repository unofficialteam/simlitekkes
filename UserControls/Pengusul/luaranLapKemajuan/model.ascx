<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="model.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranLapKemajuan.model" %>
    ...
    <div class="col-lg-12">
        ...
        <div style="padding: 10px;">
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-4">
                    <asp:DropDownList runat="server" ID="ddlStatusModel" CssClass="form-control"
                        OnSelectedIndexChanged="ddlStatusModel_SelectedIndexChanged" AutoPostBack="true"
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbNamaModel" CssClass="form-control" Text=""></asp:TextBox>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-2">
                ...
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbPemegangModel" CssClass="form-control" Text=""
                        placeHolder="Ketik nama pemegang model (pisahkan menggunakan titik koma)"></asp:TextBox>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-2">
