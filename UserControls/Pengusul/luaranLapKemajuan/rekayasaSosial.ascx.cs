...
{
    public partial class rekayasaSosial : System.Web.UI.UserControl
    {
        ...
        luaranRekayasaSosial mdlRS = new luaranRekayasaSosial();
            ...
            string thnPelaksanaan, int idJenisLuaran, string kdTahapanKegiatan)
        {
            ...
            {
                isiDdlStatusTargetTTG();
                ddlStatusRekayasaSosial.SelectedValue = dt.Rows[0]["id_target_jenis_luaran"].ToString();
        ...
        private void showHidePanelRekayasaSosial()
        {
            ...
            DataTable dt = new DataTable();
            mdlLapKemajuan.ListJenisDokumen(ref dt, int.Parse(ddlStatusRekayasaSosial.SelectedValue));
        ...
        private void initData(int idTargetJenisLuaran, bool pilih = false)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                isiAtributRekayasaSosial(int.Parse(dt.Rows[0]["id_target_luaran"].ToString()));
        ...
        private void isiAtributRekayasaSosial(int id_target_luaran)
        {
            DataTable dt = new DataTable();
            mdlRS.getDataTargetLuaranRekayasaSosial(ref dt, id_target_luaran);
            if (dt.Rows.Count > 0)
            {
                tbNamaRekayasaSosial.Text = dt.Rows[0]["nama_rekayasa_sosial"].ToString();
                tbPemegangRekayasaSosial.Text = dt.Rows[0]["pemegang_rekayasa_sosial"].ToString();
        ...
        private void isiDdlStatusTargetTTG()
        {
            DataTable dt = new DataTable();
            mdlLapKemajuan.ListTargetJenisLuaran(ref dt, 28); // rekayasa sosial
            ddlStatusRekayasaSosial.Items.Clear();
            ddlStatusRekayasaSosial.DataSource = dt;
            ddlStatusRekayasaSosial.DataBind();
        ...
        protected void lbSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (tbNamaRekayasaSosial.Text.Trim().Length == 0) emptyField.Add("Nama Rekayasa Sosial");
            if (tbPemegangRekayasaSosial.Text.Trim().Length == 0) emptyField.Add("Nama Pemegang Rekayasa Sosial");
            ...
            int status = int.Parse(ddlStatusRekayasaSosial.SelectedValue);
...

            {
                ...
                if (mdlRS.insupTargetLuaranRekayasaSosial(
                    int.Parse(ViewState["id_target_luaran"].ToString()),
                    tbNamaRekayasaSosial.Text,
                    tbPemegangRekayasaSosial.Text,
                    tbTglAwal.Text,
                    tbTglAkhir.Text,
                    tbLinkVideo.Text
                    ))
        ...
        {
            tbNamaRekayasaSosial.Text = string.Empty;
            tbPemegangRekayasaSosial.Text = string.Empty;
