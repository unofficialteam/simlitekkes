<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="tTG.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranLapKemajuan.tTG" %>
    ...
    <div class="col-lg-12">
        ...
        <div style="padding: 10px;">
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-4">
                    <asp:DropDownList runat="server" ID="ddlStatusTTG" CssClass="form-control"
                        DataTextField="nama_target_jenis_luaran" DataValueField="id_target_jenis_luaran"
                        OnSelectedIndexChanged="ddlStatusTTG_SelectedIndexChanged" AutoPostBack="true">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbNamaTTG" CssClass="form-control" placeholder="Nama TTG" Text=""></asp:TextBox>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-2">
                ...
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbPemegangTTG" CssClass="form-control" placeholder="Ketik nama pemegang Teknologi Tepat Guna (pisahkan menggunakan titik koma)" Text=""></asp:TextBox>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-3">
