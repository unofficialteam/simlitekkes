...
{
    public partial class tTG : System.Web.UI.UserControl
    {
        ...
        luaranTTG mdlTTG = new luaranTTG();
            ...
            string thnPelaksanaan, int idJenisLuaran, string kdTahapanKegiatan)
        {
            ...
            {
                isiDdlStatusTargetTTG();
                ddlStatusTTG.SelectedValue = dt.Rows[0]["id_target_jenis_luaran"].ToString();
                initData(int.Parse(dt.Rows[0]["id_target_jenis_luaran"].ToString()), true);
            }
            else
            {
                isiDdlStatusTargetTTG();
                initData(int.Parse(ddlStatusTTG.SelectedValue), false);
            }
        ...
        protected void ddlStatusTTG_SelectedIndexChanged(object sender, EventArgs e)
        {
            initData(int.Parse(ddlStatusTTG.SelectedValue), true);
            showHidePanelTTG();
            if (OnChildEvent != null)
                OnChildEvent(sender, null);
        }

        private void showHidePanelTTG()
        {

            lblPeriodePenerapan.Visible = false;
            lblPeriodeCoba.Visible = false;
            if (ddlStatusTTG.SelectedValue == "78")
            {
                lblPeriodeCoba.Visible = true;
            }
            if (ddlStatusTTG.SelectedValue == "79")
            {
                lblPeriodePenerapan.Visible = true;
            }

            DataTable dt = new DataTable();
            mdlLapKemajuan.ListJenisDokumen(ref dt, int.Parse(ddlStatusTTG.SelectedValue));
        ...
        {
            DataTable dt = new DataTable();
            mdlTTG.getDataTargetLuaranTTG(ref dt, id_target_luaran);
            if (dt.Rows.Count > 0)
            {
                tbNamaTTG.Text = dt.Rows[0]["nama_ttg"].ToString();
                tbPemegangTTG.Text = dt.Rows[0]["pemegang_ttg"].ToString();
        ...
        {
            DataTable dt = new DataTable();
            mdlLapKemajuan.ListTargetJenisLuaran(ref dt, 17); // ttg
            ddlStatusTTG.Items.Clear();
            ddlStatusTTG.DataSource = dt;
            ddlStatusTTG.DataBind();
        ...
        protected void lbSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (tbNamaTTG.Text.Trim().Length == 0) emptyField.Add("Nama TTG");
            if (tbPemegangTTG.Text.Trim().Length == 0) emptyField.Add("Nama Pemegang TTG");
            ...
            int status = int.Parse(ddlStatusTTG.SelectedValue);
...

            {
                ...
                if (mdlTTG.insupTargetLuaranTTG(
        ...
        {
            tbNamaTTG.Text = string.Empty;
            tbPemegangTTG.Text = string.Empty;
