<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="purwarupaPrototipe.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranLapKemajuan.purwarupaPrototipe" %>

<div class="row" style="padding: 10px;">
    <div class="col-lg-12">
        <div>
            <asp:Label runat="server" ID="lblJudulForm" ForeColor="Green" Font-Bold="true"
                Text="Purwarupa (Prototipe)">
            </asp:Label>
        </div>
        <div style="padding: 10px;">
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-4">
                    <asp:DropDownList runat="server" ID="ddlStatusPurwarupaPrototipe" CssClass="form-control"
                        DataTextField="nama_target_jenis_luaran" DataValueField="id_target_jenis_luaran"
                        OnSelectedIndexChanged="ddlStatusPurwarupaPrototipe_SelectedIndexChanged" AutoPostBack="true">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbPemegangPurwarupa" CssClass="form-control" placeholder="Ketik nama pemegang Purwarupa (pisahkan menggunakan titik koma)" Text=""></asp:TextBox>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-3">
