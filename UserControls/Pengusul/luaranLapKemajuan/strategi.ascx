<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="strategi.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranLapKemajuan.strategi" %>
    ...
    <div class="col-lg-12">
        ...
        <div style="padding: 10px;">
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-4">
                    <asp:DropDownList runat="server" ID="ddlStatusStrategi" CssClass="form-control"
                        DataTextField="nama_target_jenis_luaran" DataValueField="id_target_jenis_luaran"
                        OnSelectedIndexChanged="ddlStatusStretegi_SelectedIndexChanged" AutoPostBack="true">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbNamaStrategi" CssClass="form-control" placeholder="Nama Strategi" Text=""></asp:TextBox>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-2">
                ...
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbPemegangStrategi" CssClass="form-control" placeholder="Ketik nama pemegang Strategi (pisahkan menggunakan titik koma)" Text=""></asp:TextBox>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-3">
