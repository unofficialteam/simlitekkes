<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="keyNoteSpeaker.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranLapKemajuan.keyNoteSpeaker" %>
    ...
    <div class="col-lg-12">
        ...
        <div style="padding: 10px;">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbNamaKonferens" CssClass="form-control" placeholder="Nama pertemuan ilmiah"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 10px;">                
                <asp:Panel runat="server" ID="pnlISSN" Visible="false">
                <div class="col-lg-2">
                    ISSN/EISSN
                </div>
                <div class="col-lg-4">
