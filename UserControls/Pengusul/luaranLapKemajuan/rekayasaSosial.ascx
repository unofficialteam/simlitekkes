<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rekayasaSosial.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranLapKemajuan.rekayasaSosial" %>
    ...
    <div class="col-lg-12">
        ...
        <div style="padding: 10px;">
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-2">
                    Status Rekayasa Sosial
                </div>
                <div class="col-lg-4">
                    <asp:DropDownList runat="server" ID="ddlStatusRekayasaSosial" CssClass="form-control"
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbNamaRekayasaSosial" CssClass="form-control" placeholder="Nama Rekayasa Sosial" Text=""></asp:TextBox>
                </div>
            </div>
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-2">
                    Pemegang Rekayasa Sosial
                </div>
                <div class="col-lg-10">
