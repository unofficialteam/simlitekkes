<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="bukuHasilPenelitian.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranLapKemajuan.bukuHasilPenelitian" %>

<div class="row" style="padding: 10px;">
    <div class="col-lg-12">
        <div>
            <asp:Label runat="server" ID="lblJudulForm" ForeColor="Green" Font-Bold="true"
                Text="Buku Hasil Penelitian">
            </asp:Label>
        </div>
        <div style="padding: 10px;">
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-2">
                    Status buku hasil penelitian
                </div>
                <div class="col-lg-4">
                    <asp:DropDownList runat="server" ID="ddlStatusBuku" CssClass="form-control"
                        DataTextField="nama_target_jenis_luaran" DataValueField="id_target_jenis_luaran"
                        OnSelectedIndexChanged="ddlStatusBuku_SelectedIndexChanged" 
                        AutoPostBack="true" >
            ...
            <asp:Panel runat="server" ID="pnlIsbn" Visible="false">
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-lg-2">
                        <asp:TextBox runat="server" ID="tbTahunTerbit" CssClass="form-control"
            ...
            <asp:Panel runat="server" ID="pnlUrlBuku" Visible="false">
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-lg-10">
                        <asp:TextBox runat="server" ID="tbUrlBuku" CssClass="form-control" placeholder="Apabila ada" Text=""></asp:TextBox>
                    </div>
                </div>
            </asp:Panel>
