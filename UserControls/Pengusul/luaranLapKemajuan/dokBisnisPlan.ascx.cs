...
{
    public partial class dokBisnisPlan : System.Web.UI.UserControl
    {
        public event EventHandler OnChildEvent;
        uiNotify noty = new uiNotify();
        Models.login objLogin;
        luaranLaporanKemajuan mdlLapKemajuan = new luaranLaporanKemajuan();
        simlitekkes.Models.pelaksanaan.dokBisnisPlan mdlbisnisplan = new simlitekkes.Models.pelaksanaan.dokBisnisPlan();
        ...
        private void initData(int idTargetJenisLuaran, bool pilih = false)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    if (id_jenis_dokumen_bukti_luaran == 26 || id_jenis_dokumen_bukti_luaran == 29 || id_jenis_dokumen_bukti_luaran == 97 || id_jenis_dokumen_bukti_luaran == 100)
                    {
                    ...
                    if (id_jenis_dokumen_bukti_luaran == 27 || id_jenis_dokumen_bukti_luaran == 30 || id_jenis_dokumen_bukti_luaran == 98 || id_jenis_dokumen_bukti_luaran == 101)
                    {
                    ...
                    if (id_jenis_dokumen_bukti_luaran == 28 || id_jenis_dokumen_bukti_luaran == 31 || id_jenis_dokumen_bukti_luaran == 99 || id_jenis_dokumen_bukti_luaran == 102)
                    {
        ...
        {
            DataTable dt = new DataTable();
            mdlbisnisplan.getDataTargetLuaranBisnisPlan(ref dt, id_target_luaran);
            if (dt.Rows.Count > 0)
            {
                //ddlStatusDokumen.SelectedValue = dt.Rows[0]["id_target_luaran"].ToString();
                tbNamaProduk.Text = dt.Rows[0]["nama_produk"].ToString();

                tbMerek.Text = dt.Rows[0]["merek"].ToString();
                tbNoSertifikatMerek.Text = dt.Rows[0]["no_sertifikat_merek"].ToString();
                tbNoSertifikatDesainIndustri.Text = dt.Rows[0]["no_sertifikat_desain_industri"].ToString();

                tbTglSertifikatMerek.Text = dt.Rows[0]["tgl_sertifikat_merek"].ToString() != "" ?
                    DateTime.Parse(dt.Rows[0]["tgl_sertifikat_merek"].ToString()).ToString("yyyy-MM-dd") : "";

                tbTglSertifikatDesainIndustri.Text = dt.Rows[0]["tgl_sertifikat_desain_industri"].ToString() != "" ?
                    DateTime.Parse(dt.Rows[0]["tgl_sertifikat_desain_industri"].ToString()).ToString("yyyy-MM-dd") : "";
            }
        }
        ...
        private void clearTextBox()
        {
            ...
            tbMerek.Text = string.Empty;
            tbNoSertifikatMerek.Text = string.Empty;
            tbTglSertifikatMerek.Text = string.Empty;
            tbNoSertifikatDesainIndustri.Text = string.Empty;
            tbTglSertifikatDesainIndustri.Text = string.Empty;
        ...
        protected void lbSimpan_Click(object sender, EventArgs e)
        {
           ...
           ))
            {
                ...
                if (mdlbisnisplan.insupTargetDokBisnisPlan(
                    int.Parse(ViewState["id_target_luaran"].ToString()),

                    tbNamaProduk.Text,
                    tbMerek.Text,
                tbNoSertifikatMerek.Text,
                tbTglSertifikatMerek.Text,
                tbNoSertifikatDesainIndustri.Text,
                tbTglSertifikatDesainIndustri.Text
