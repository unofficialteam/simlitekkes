<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="dokHasilUjiCobaDiLingkungan.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranLapKemajuan.dokHasilUjiCobaDiLingkungan" %>
...
<div class="row" style="padding: 10px;">
    <div class="col-lg-12">
        ...
        <div style="padding: 10px;">
            ...
            <div class="row" style="margin-top: 10px;">
                <div class="col-lg-2">
                    Link video dokumentasi uji coba
                </div>
                <div class="col-lg-10">
                    <asp:TextBox runat="server" ID="tbLinkVideo" CssClass="form-control"
                        placeholder="Link video dokumentasi uji coba" Text=""></asp:TextBox>
                </div>
            </div>
