<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rekapUsulanPerbaikan.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.PerbaikanProposal.rekapUsulanPerbaikan" %>
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body" style="padding: 10px;">
                <table width="100%">
                    <tr>
                        <td style="background-color: #ddd; height: 30px; vertical-align: middle;">&nbsp;&nbsp;Dokumen Usulan Perbaikan
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <table>
                                <tr>
                                    <td style="color: maroon;" colspan="2"><b>Dokumen usulan perbaikan</b></td>
                                </tr>
                                <tr valign="top">
                ...
                <asp:Panel runat="server" ID="pnlKekDokumenUsulan" Style="margin-bottom: 30px;">
                    <div style="background-color: #ffaaaa;" class="alert alert-light" role="alert">
                        <asp:Label runat="server" ID="lblInfoDokUsulan" Text="Dokumen usulan perbaikan belum diunggah"></asp:Label>
                    </div>
                </asp:Panel>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body" style="padding: 10px;">
                ...
                <asp:Panel runat="server" ID="pnlAnggotaNonDikti" Visible="false">
                    <table width="100%">
                        <tr>
                            <td style="background-color: #ddd; height: 30px; vertical-align: middle;">&nbsp;&nbsp;Identitas Pengusul - Anggota Peneliti Non Ristekdikti (<asp:Label runat="server" ID="lblJmlAnggotaNonDikti"></asp:Label>)
                            </td>
                        </tr>
                        <tr>
                            <td>
        ...
        <div class="card">
            <div class="card-body" style="padding: 10px;">
                                    ...
                                    <td>
                                        <table>
                                            ...
                                            <asp:Label runat="server" ID="lblTahun3" Text="0"></asp:Label>
                                                        ...
                                                        <ItemTemplate>
                                                            <li>Dana Pengajuan Tahun <%# Eval("urutan_tahun") %>
                                                                <strong>Rp. <%# decimal.Parse(Eval("dana_diajukan").ToString()).ToString("N0") %></strong> - Dana yang disetujui 
                                                <strong>Rp. <%# decimal.Parse(Eval("dana_disetujui").ToString()).ToString("N0") %></strong>
                                                    ...
                                                    <asp:Panel runat="server" ID="pnlTotal">
                                                        ...
                                                        <div style="margin-left: 20px;">
                                                            &nbsp;Total Dana Di Ajukan<asp:Label runat="server" ID="lblTotalDanaAjukan" Text="Total Dana Rp. 0"></asp:Label><br />
                                                            &nbsp;Total Dana Di Setujui<asp:Label runat="server" ID="lblTotalDanaSetujui" Text="Total Dana Rp. 0"></asp:Label>

                                                        </div>
                                                    </asp:Panel>--%>

                <div class="row equal" style="color: #fff; font-size: 14px; margin-left: 2px; margin-right: 2px;">
                ...
                <%--</td>
                                            ...
                                            <asp:Label runat="server" ID="lblBidangFokus" ></asp:Label><br />
                                                        &nbsp;- Minimal: Rp.
                ...
                <asp:Panel runat="server" ID="pnlKekRab" Style="margin-bottom: 30px;">
                    <div style="background-color: #ffaaaa;" class="alert alert-light" role="alert">
                        <asp:Label runat="server" ID="lblKekRab" Text="Rab dana disetujui dengan dana direncanakan tidak sama."></asp:Label>
                    </div>
                </asp:Panel>
            </div>
        </div>
        ...
        <asp:Panel runat="server" ID="panelWbs" Visible="false">
            ...
            <div class="card">
                <div class="card-body" style="padding: 10px;">
                    <table width="100%">
                        <tr>
                            <td style="background-color: #ddd; vertical-align: middle;" class="auto-style1">&nbsp;&nbsp;Dokumen WBS (Work Breakdown Structure)
                            </td>
                        </tr>
                        <tr>
                            <td>
                                        ...
                                        <asp:TemplateField HeaderText="Mitra">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton runat="server" ID="lbUnduhDokMitraPelaksanaPenelitian"
                                                    ...
                                                    CommandArgument="<%# Container.DataItemIndex %>"><i class="fa fa-file-pdf-o fa-2x"></i>
                                                </asp:LinkButton>
                                                Tgl.Unggah Data:
