<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="publikasiNBuku.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaranAbdimas2019.publikasiNBuku" %>
...
<div class="row">
    ...
    <div class="col-lg-8 text-left">
        <asp:DropDownList runat="server" ID="ddlJenisLuaran" CssClass="form-control" Width="300" AutoPostBack="true"
            DataTextField="nama_jenis_luaran" DataValueField="id_jenis_luaran" OnSelectedIndexChanged="ddlJenisLuaran_SelectedIndexChanged">
...
<div class="row">
    <div class="col-lg-4 text-right">
        <asp:Label runat="server" ID="lblRencanaNama" Text=""></asp:Label>
    </div>
    <div class="col-lg-8 text-left">
       <asp:TextBox runat="server" ID="tbRencanaNama" CssClass="form-control" Width="300"
