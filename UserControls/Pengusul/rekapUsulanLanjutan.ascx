<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rekapUsulanLanjutan.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.rekapUsulanLanjutan" %>
                            ...
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Panel runat="server" ID="pnlThn1" Visible="false">
                                                    Tahun 1: Rp.
