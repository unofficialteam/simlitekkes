<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rekapUsulan.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.pendanaan2021.rekapUsulan" %>
    ...
    <div class="card mb-4">
        <div class="card-body" style="padding: 10px;">
            ...
            <asp:Panel runat="server" ID="pnlKekRab" Style="margin-bottom: 30px;">
                <div style="background-color: #ffaaaa;" class="alert alert-light" role="alert">
                    <asp:Label runat="server" ID="lblKekRab" Text="RAB belum diisi dengan lengkap."></asp:Label>
                </div>
            </asp:Panel>
        </div>
    </div>
        ...
        <div class="card-body" style="padding: 10px;">
            <asp:Panel runat="server" ID="pnlDokPendukung" Visible="true">
                ...
                <div style="padding-bottom: 10px;">
                    <asp:Label ID="lblInfoMitra" runat="server" Text="Pilihan Skema tidak Wajib Memiliki Mitra" Font-Size="Large" Font-Bold="true" ForeColor="Orange" Visible="false"></asp:Label>
                        ...
                        <div>
                            <div>
                                Mitra Pelaksana Penelitian&nbsp;<asp:Label ID="lblTdkWajibMitra" runat="server" Text="Tidak Wajib Ada"
                                    Font-Bold="true" Font-Size="X-Small" ForeColor="Red" Font-Italic="true" BackColor="Yellow" Visible="false"></asp:Label>
                            </div>
                    ...
                    <asp:Panel ID="panelMitraCalonPengguna" runat="server" Visible="true">
                        <div>
                            <div>
                                Mitra Calon Pengguna<asp:Label ID="lblWajibMCP" runat="server" Text="Wajib Ada" Font-Size="X-Small" Font-Bold="true" ForeColor="Red" Font-Italic="true" BackColor="Yellow" Visible="false"></asp:Label>
                            </div>
                    ...
                    <asp:Panel ID="panelMitraInvestor" runat="server" Visible="true">
                        <div >
                            <div>
                                Mitra Investor&nbsp;<asp:Label ID="lblWajibMI" runat="server" Text="Wajib Ada" Font-Size="XX-Small" ForeColor="Red" Font-Italic="true" BackColor="Yellow" Visible="false"></asp:Label>
                            </div>
            ...
            <asp:Panel runat="server" ID="pnlKekMitra">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div style="background-color: #ffaaaa;" class="alert alert-light" role="alert">
                            <asp:Label runat="server" ID="lblKekMitra" Text="Dokumen mitra belum diunggah"></asp:Label>
                        </div>
                    </div>
                </div>
            </asp:Panel>
