<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="persyaratanUmum.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.pendanaan2021.persyaratanUmum" %>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                           <asp:Panel runat="server" ID="panelNonAktif">
