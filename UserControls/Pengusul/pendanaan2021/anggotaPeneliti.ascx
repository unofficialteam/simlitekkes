<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="anggotaPeneliti.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.pendanaan2021.anggotaPeneliti" %>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                ...
                                <b>
                                    <asp:Label ID="lblPersetujuan" runat="server" Text='<%# Bind("status_konfirmasi") %>' Font-Size="Small" ForeColor="Green" Visible="false"></asp:Label></b>
                            </ItemTemplate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="lblKualifikasi">Kualifikasi :</label>&nbsp;
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="lblSurel">Email :</label>
                                    <asp:Label runat="server" ID="lblSurel" Text="-"></asp:Label>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="ddlPeran">Peran :</label>
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="tbJudulHKI">Tugas dalam penelitian</label>
...
<div class="modal modal-danger" id="modalHapusTendikKemkes" role="dialog" aria-labelledby="myModalHapusNonDIkti">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalHapusTendikKemkes">Konfirmasi Hapus Data</h4>
            </div>
            <div class="modal-body">
                Apakah yakin akan menghapus data
