...
{
    public partial class anggotaPeneliti : System.Web.UI.UserControl
    {
        ...
        //string idUsulanKegiatan = //"7414f38d-bc90-4117-b996-4ea131c299c0";//"d49c28ce-384a-46bc-b324-3c2498f93a14";// "9bc13149-addc-4c1f-bf2e-4a5f6d23bdf9";//"439bea51-592f-4f37-bd72-40c5477fc349";//
        ...
        protected void lbSimpan_Click(object sender, EventArgs e)
        {
            ...
            //if (ViewState["id_skema"].ToString() == "5" || ViewState["id_skema"].ToString() == "70" &&
            //      (ddlPeran.SelectedValue == "C1" || ddlPeran.SelectedValue == "D1")
            //) // pekerti cek tpm
            //{
            ...
            //    float alokasi_waktu = float.Parse("");

            //    if (!objAnggota.insertDataBaruAnggota(idPersonal, Guid.Parse(ViewState["id_usulan_kegiatan"].ToString()),
            //            kdPeranPersonil, urutanPeran, alokasi_waktu, bidang_tugas)) //float.Parse(tbAlokasiWaktu.Text)))
            //    {
            //        noty.Notify(this.Page, uiNotify.NotifyType.error, "Terjadi Kesalahan",
        ...
        protected void gvAnggotaPengusulDikti_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string id_personil = gvAnggotaPengusulDikti.DataKeys[e.Row.RowIndex]["id_personil"].ToString();
                if (kd_sts_konfirmasi == "0")
                {
                    objKonfirmasi.updateStsKonfirmasi("1", Guid.Parse(id_personil));
                }
        ...
        protected void gvAnggotaPengusulTendik_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string id_personil = gvAnggotaTendikKemkes.DataKeys[e.Row.RowIndex]["id_personil"].ToString();
                if (kd_sts_konfirmasi == "0")
                {
                    objKonfirmasi.updateStsKonfirmasi("1", Guid.Parse(id_personil));
                }
