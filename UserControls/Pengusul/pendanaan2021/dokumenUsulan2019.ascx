<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="dokumenUsulan2019.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.pendanaan2021.dokumenUsulan2019" %>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <table>
                                <tr>
                                    <td>
                                        <asp:LinkButton runat="server" ID="lbUnduhTemplateDok2" Text="" Font-Bold="true" OnClick="lbUnduhTemplateDok_Click" Visible="false">
                                    ...
                                    <td style="padding-left: 5px; width: 100px;">
                                        ...
                                        <asp:LinkButton runat="server" ID="lbUnduhTemplateDok" Text="Unduh" Font-Bold="true" OnClick="lbUnduhTemplateDok_Click" Visible="false"></asp:LinkButton>
                                            </div>
                                    </td>
                                    <td style="padding-left: 5px; width: 100px;">
