<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IdentitasUsulan.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.pendanaan2021.IdentitasUsulan" %>
            ...
            <div class="col-sm-12">
                <div class="card mb-4" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="form text-center" style="margin-top: 20px; display: none;">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <asp:RadioButtonList ID="rblKategoriPenelitian" runat="server" RepeatDirection="Horizontal"
                                        RepeatLayout="Flow" AutoPostBack="false" Enabled="false"
                        ...
                        <asp:Panel ID="panelTopikUnggulanPT" runat="server" Visible="true">
                            ...
                            <div class="form-group row">
                                <label for="3" class="col-sm-2">Tema Unggulan PT</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2">Topik Unggulan PT</label>
