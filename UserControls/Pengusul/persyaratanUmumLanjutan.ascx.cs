...
{
    public partial class persyaratanUmumLanjutan : System.Web.UI.UserControl
    {
        ...
        public int isiDataPersyaratanUmum()
        {
            ...
            if (objPersyaratan.getJmlUsulanBaru(ref dtJmlUsulanBaru, id_personal, thn_kegiatan, kd_jenis_kegiatan))
            {
