...
{
    public partial class publikasiProsiding : System.Web.UI.UserControl
    {
        ...
        public void isiLuaranPublikasProsiding(Guid idLuaranDijanjikan, string idJenisLuaran, string thnPelaksanaan)
        {
            ...
            if(idJenisLuaran == "4")
            {
                lblProsidingInternasional.Visible = true;
                lblProsidingNasional.Visible = false;
                lblProsidingLokal.Visible = false;
            }
            else if(idJenisLuaran == "3")
            {
                lblProsidingInternasional.Visible = false;
                lblProsidingNasional.Visible = true;
                lblProsidingLokal.Visible = false;
            }
            else if (idJenisLuaran == "22")
            {
                lblProsidingInternasional.Visible = false;
                lblProsidingNasional.Visible = false;
                lblProsidingLokal.Visible = true;
            }
        }
        ...
        protected void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (modelPengusul.insupLuaranPublikasiProsiding(
