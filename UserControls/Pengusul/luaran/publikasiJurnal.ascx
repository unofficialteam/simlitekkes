<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="publikasiJurnal.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.luaran.publikasiJurnal" %>
    ...
    <div class="col-sm-12">
        <div class="panel panel-default m-t-20">
            <div class="panel-heading bg-default txt-white">
                <asp:Label ID="lblJurnalInternasional" runat="server">Data Publikasi Ilmiah Jurnal Internasional 
                </asp:Label>
                <asp:Label ID="lblJurnalNasionalTer" runat="server">Data Publikasi Ilmiah Jurnal Nasional Terakreditasi 
                </asp:Label>
                 <asp:Label ID="lblJurnalNasionalTdkTer" runat="server">Data Publikasi Ilmiah Jurnal Nasional Tidak Terakreditasi
                </asp:Label>
            </div>
            <div class="panel-body p-15">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="col-sm-2 col-form-label form-control-label">DOI <b style="color:red">(jika ada)</b></label>
                        <div class="col-sm-10">
                            <asp:TextBox ID="tbDOI" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group">
                        <label class="col-sm-4 col-form-label form-control-label">Unggah Surat Keterangan Accepted atau Artikel Peprinted </label>
                        <div class="col-sm-8">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="col-sm-4 col-form-label form-control-label">Unggah Artikel</label>
                        <div class="col-sm-8">
