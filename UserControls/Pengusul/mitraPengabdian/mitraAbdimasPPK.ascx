<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="mitraAbdimasPPK.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.mitraPengabdian.mitraAbdimasPPK" %>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12  mt-2">
                                <asp:GridView ID="gvMitraPelaksanaPengabdian"
                                    runat="server" GridLines="None" ShowHeader="true"
                                    ShowHeaderWhenEmpty="true"
                                    AutoGenerateColumns="False" DataKeyNames="IdMitraAbdimas, NamaPimpinanInstitusi"
                                    OnRowUpdating="gvMitraPelaksanaPengabdian_RowUpdating"
                                    ItemType="simlitekkes.Models.Pengusul.Mitra.PTPelaksana"
                                    OnRowDeleting="gvMitraPelaksanaPengabdian_RowDeleting" OnRowCommand="gvMitraPelaksanaPengabdian_RowCommand">
                                    <%-- 
                                                OnRowDataBound="gvMitraPelaksanaPengabdian_RowDataBound"
                                                ...
                                                Tgl.Unggah Data:
                                                                    <asp:Label ID="lblTglUnggah" runat="server" Text='<%# Item.TglUnggahPernyataan.ToString("dd/MM/yyyy") %>'>
                                                                        ...
                                                                        <asp:LinkButton ID="lbUnduh" runat="server" CommandName="unduhDokumenMitraPelaksana"
                                                                            CommandArgument="<%# Container.DataItemIndex %>" ForeColor="White" CssClass="btn btn-info btn-sm ml-2"><i class="fas fa-download mr-2"></i>Unduh</asp:LinkButton>
                                            </ItemTemplate>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Mitra">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton runat="server" ID="lbUnggahDokMitraPelaksanaPengabdian"
                                                    class="btn btn-primary" data-toggle="tooltip" CommandName="unggahDokMitraPemkot"
                                                    CommandArgument="<%# Container.DataItemIndex %>"><i class="fas fa-upload"></i>
                                                </asp:LinkButton>
                                                Tgl.Unggah Data:
                                                                    <asp:Label ID="lblTglUnggah" runat="server" Text='<%# Item.TglUnggahPernyataan.ToString("dd/MM/yyyy") %>'>
                                                                    </asp:Label>
                                                <asp:LinkButton ID="lbUnduh" runat="server" CommandName="unduhDokumenMitraPemkot"
                                                    CommandArgument="<%# Container.DataItemIndex %>" ForeColor="White" CssClass="btn btn-info btn-sm ml-2"><i class="fas fa-download mr-2"></i>Unduh</asp:LinkButton>
                                            </ItemTemplate>
                                            <HeaderStyle Width="68%" />
                                            <ItemStyle Font-Bold="false" />
                                        ...
                                        <asp:TemplateField HeaderText="Kontribusi Pendanaan">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDanaThn1" runat="server" Text="Tahun 1:Rp"></asp:Label>
                                                <asp:Label ID="lblDana1" runat="server" Text='<%# Item.DanaTahun1 %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Font-Bold="false" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="">
