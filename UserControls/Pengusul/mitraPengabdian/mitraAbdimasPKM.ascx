<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="mitraAbdimasPKM.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.mitraPengabdian.mitraAbdimasPKM" %>
            ...
            <div class="col-sm-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <i>Kelompok Masyarakat (<asp:Label ID="lblKelMasyarakat" runat="server" Text="0"></asp:Label>)</i>&nbsp;&nbsp;
