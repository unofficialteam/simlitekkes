...
{
    public partial class mitraAbdimasPPPUD : System.Web.UI.UserControl
    {
        ...
        public void isigvKelMasyarakat()
        {
            ...
            try
            {
                ...
                lblJmlMitraSasaran.Text = listMitra.Count.ToString();

                lbKelMasyarakat.Visible = (listMitra.Count == 0);
            }
            catch (Exception ex)
            {
                noty.Notify(this.Page, uiNotify.NotifyType.error, "Terjadi Kesalahan", ex.Message);
