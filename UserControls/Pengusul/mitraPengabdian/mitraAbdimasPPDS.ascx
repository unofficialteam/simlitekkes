<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="mitraAbdimasPPDS.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.mitraPengabdian.mitraAbdimasPPDS" %>
