...
{
    public partial class rekapLuaran : System.Web.UI.UserControl
    {
        ...
        private void isiDdlThnPelaksanaan()
        {
            ...
            int thnSKg = 2018; //int.Parse(DateTime.Now.Year.ToString());
        ...
        private void isiGvLuaranDicapai()
        {
            objLogin = (Models.login)Session["objLogin"];
            DataTable dt = new DataTable();
            Guid idPersonal = Guid.Parse(objLogin.idPersonal);
            objLuaran.rekapLuaran(ref dt, idPersonal, ddlThnPelaksanaan.SelectedValue);
            gvLuaranDicapai.DataSource = dt;
