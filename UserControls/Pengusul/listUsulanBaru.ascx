<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="listUsulanBaru.ascx.cs" Inherits="simlitekkes.UserControls.Pengusul.listUsulanBaru" %>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 style="color: darkred">Daftar Usulan Penelitian Baru</h5>
                        </div>
