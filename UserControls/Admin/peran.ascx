<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="peran.ascx.cs" Inherits="simlitekkes.UserControls.Admin.peran" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:TextBox runat="server" ID="tbPencarian" CssClass="form-control" placeholder="Masukkan Nama Peran"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvDaftarData" runat="server" GridLines="None"
                                            ...
                                            DataKeyNames="id_peran, nama_peran, keterangan, kd_kelompok_peran, kelompok_peran"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Peran" HeaderStyle-Width="35%">
                                                    <ItemTemplate>
                                                        <b><asp:Label runat="server" ID="lblNamaPeran" Text='<%# Bind("nama_peran") %>'></asp:Label></b><hr />
                                                        <small>Kelompok Peran. <asp:Label runat="server" ID="lblKelompokPeran" Text='<%# Bind("kelompok_peran") %>'></asp:Label></small>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Keterangan" HeaderStyle-Width="40%">
                                                    <ItemTemplate>
                                                        <asp:Label runat="server" ID="lblKeterangan" Text='<%# Bind("keterangan") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlAddKelompokPeran" CssClass="form-control select2"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Nama Peran</label>
                                            <asp:TextBox runat="server" ID="tbAddNamaPeran" CssClass="form-control" placeholder="Masukkan Nama Peran"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Keterangan</label>
                                            <asp:TextBox runat="server" ID="tbKeterangan" CssClass="form-control" placeholder="Masukkan Keterangan"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="clearfix">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Apakah yakin akan menghapus Data&nbsp;<asp:Label runat="server" ID="lblData" Text=""></asp:Label>&nbsp;?
                    </div>
