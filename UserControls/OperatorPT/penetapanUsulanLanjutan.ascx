<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="penetapanUsulanLanjutan.ascx.cs" Inherits="simlitekkes.UserControls.OperatorPT.penetapanUsulanLanjutan" %>
