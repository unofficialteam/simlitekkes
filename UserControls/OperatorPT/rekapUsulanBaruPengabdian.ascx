<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rekapUsulanBaruPengabdian.ascx.cs" Inherits="simlitekkes.UserControls.OperatorPT.rekapUsulanBaruPengabdian" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main-header" style="margin-top: 0px; color: #313233e3;">
                    <h4>Usulan Baru Kegiatan Pengabdian</h4>
                </div>
            </div>
            <!-- awal pilih kategori -->
            <div class="row">
