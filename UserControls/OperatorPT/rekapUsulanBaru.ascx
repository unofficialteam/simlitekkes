<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rekapUsulanBaru.ascx.cs" Inherits="simlitekkes.UserControls.OperatorPT.rekapUsulanBaru" %>
...
<%@ Register Src="~/UserControls/Pengusul/report/pdfUsulanLengkapAbdimas.ascx" TagPrefix="uc" TagName="pdfUsulanLengkapAbdimas" %>
                                ...
                                <div class="box-body">
                                    <asp:GridView runat="server" ID="gvDaftarSkema" CssClass="table table-striped table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Blm ditinjau">
                                                <ItemTemplate>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-8" style="font-size: 16px;">
                    ...
                    |
                    &nbsp;Jml Usulan:
                    <asp:Label ID="lblJmlUsulanBaru" runat="server" ForeColor="ForestGreen"></asp:Label>
                </div>
            </div>
            <div class="row" style="padding-top: 10px;">
                ...
                <div class="col-sm-4 m-t-20 text-right">
                    <asp:LinkButton ID="lbKembali" runat="server" class="btn btn-info"
                        OnClick="lbKembali_Click">Kembali</asp:LinkButton>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12" style="margin: 10px 0px;">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="form-inline text-right" style="color: #7cab3f;">
                            ...
                            &nbsp;&nbsp;                   
                                <asp:LinkButton ID="lbExcelRekapSkema" runat="server" ToolTip="Export Excel" ForeColor="Green" OnClick="lbExportExcel_Click">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" style="padding-bottom: 10px;">
                    <div class="panel panel-default" style="min-height: 100px;">
                        <asp:ListView ID="lvDaftarUsulanKonfirmasi" runat="server"
                            DataKeyNames="id_usulan_kegiatan,kd_jenis_kegiatan" OnItemDataBound="lvDaftarUsulanKonfirmasi_ItemDataBound"
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblNomor" runat="server" Text=''></asp:Label></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        Ketua: <b style="color: #7cab3f;"><%# Eval("nama_ketua") %></b> | NIDN/NIDK: <b style="color: #7cab3f;"><%# Eval("nidn") %></b>
                                        <br />
            ...
            <uc:pdfUsulanLengkap runat="server" ID="pdfUsulanLengkapAbdimas" />
        </div>
    </asp:View>
