...
namespace simlitekkes.UserControls.OperatorPT
{
    public partial class penetapanUsulanLanjutan : System.Web.UI.UserControl
    {
        ...
        Models.PT.penetapanUsulanLajutan modelPenetapanUsulanLanjutan = new Models.PT.penetapanUsulanLajutan();
        ...
        private void isiGvRekapSkema()
        {
            ...
            if (modelPenetapanUsulanLanjutan.listRekapSkema(ref dt, rblProgramHibah.SelectedValue,
                ddlThnPelaksanaan.SelectedValue, IdInstitusi))
            {
        ...
        private void isiLvPenetapan(int limit, int offset, int stsEdit)
        {
            if (modelPenetapanUsulanLanjutan.getJmlDataPenetapan(ddlThnPelaksanaan.SelectedValue,
                IdInstitusi, int.Parse(ViewState["IdSkema"].ToString()),
            ...
            if (modelPenetapanUsulanLanjutan.listPenetapan(ref dt, ddlThnPelaksanaan.SelectedValue,
                IdInstitusi, int.Parse(ViewState["IdSkema"].ToString()), tbPencarianPenetapan.Text,
        ...
        protected void lbExcelPenetapan_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage pck = new ExcelPackage())
            {
                ...
                "33", IdInstitusi, int.Parse(ViewState["IdSkema"].ToString()), tbPencarianPenetapan.Text, rblStsPenetapan.SelectedValue, 0,0))
                {
        ...
        protected void pagingPenetapan_PageChanging(object sender, EventArgs e)
        {
            ...
            //if (modelPenetapanUsulanLanjutan.listPenetapan(ref dt, ddlThnUsulan.SelectedValue, ddlThnPelaksanaan.SelectedValue,
        ...
        protected void cekJmlPermanen()
        {
            ...
            if (modelPenetapanUsulanLanjutan.getJmlPermanen(ref dt, ddlThnPelaksanaan.SelectedValue,
                IdInstitusi, int.Parse(ViewState["IdSkema"].ToString()), tbPencarianPenetapan.Text, rblStsPenetapan.SelectedValue,0,0))
            {
                if (dt.Rows.Count > 0)
                {
        ...
        protected void lbSimpanPermanen_Click(object sender, EventArgs e)
        {
                ...
                tbPencarianPenetapan.Text, rblStsPenetapan.SelectedValue, 0, 0))
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        if (!modelPenetapanUsulanLanjutan.setSimpanPermanen(
                            ddlThnPelaksanaan.SelectedValue, IdInstitusi,
