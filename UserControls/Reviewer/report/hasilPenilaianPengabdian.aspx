<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hasilPenilaianPengabdian.aspx.cs" Inherits="simlitekkes.UserControls.Reviewer.report.hasilPenilaianPengabdian" %>
    ...
    <form id="form1" runat="server" style="margin-left: 70px; margin-right: 50px;">
        <div>
            ...
            <div style="text-align: center;">
                <asp:Label runat="server" ID="lblNamaSkema" Text="" ForeColor="White" BackColor="Black" Style="font-size: 14px; font-family: Arial; font-weight: bold; padding: 3px;"></asp:Label>
            </div>
        ...
        <table style="width: 100%; font-size: 12px; font-family: 'Arial Narrow', Arial, sans-serif, Times, serif;"
            cellpadding="-1">
            <tr>
                <td style="vertical-align: top; width: 27%;">Judul Pengabdian
                </td>
            ...
            <tr>
                <td style="vertical-align: top;" class="auto-style1">Bidang Pengabdian
                </td>
            ...
            <tr>
                <td>Lama Pengabdian Keseluruhan 
                </td>
                <td style="width: 10px;">:</td>
                <td>
        ...
        <table style="font-size: 12px; font-family: Arial;">
            ...
            <tr>
                <td style="font-weight: bold;">I. Rekam Jejak</td>
            </tr>
        </table>
        <table border="1" style="width: 100%; border: 1px solid lightgray; border-collapse: collapse; font-size: 12px; font-family: 'Arial Narrow', Arial, sans-serif, Times, serif;">
            ...
            <tr>
                <td colspan="3" class="trtd_right">Sub total</td><%--(40%)--%>
                <td class="trtd">
        ...
        <table style="font-size: 12px; font-family: Arial;">
            ...
            <tr>
                <td style="font-weight: bold;">II. Substansi Usulan</td>
            </tr>
        </table>
        <table border="1" style="width: 100%; border: 1px solid lightgray; border-collapse: collapse; font-size: 12px; font-family: 'Arial Narrow', Arial, sans-serif, Times, serif;">
            ...
            <tr>
                <td colspan="3" class="trtd_right">Sub Total</td><%--(60%)--%>
                <td class="trtd">
                    <asp:Label runat="server" ID="lblSubtotalSubstansiUsulan" Text="0"></asp:Label>
                </td>
            </tr>
            <tr>
