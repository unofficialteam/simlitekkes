...
{
    public partial class hasilPenilaian : System.Web.UI.UserControl
    {
        ...
        protected byte[] GeneratePDF(string idUsulanKegiatan, string idPersonalReviewer)
        {
            ...
            {
                Server.Execute(String.Format("~/UserControls/Reviewer/report/hasilPenilaian.aspx?id_usulan_kegiatan={0}&id_personal_reviewer={1}",
