...
{
    public partial class hasilPenilaianPembahasan1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            objModel.getIdPlottingPembahasan(ref dtp, Guid.Parse(idUsulanKegiatan), Guid.Parse(idPersonalReviewer));
            if (dtp.Rows.Count > 0)
            {
                ...
                isiHasilEvaluasiUsulan(dtp.Rows[0]["id_plotting_eval_pembahasan"].ToString());
                //isiJustifikasiRAB(dtp.Rows[0]["id_plotting_eval_substansi"].ToString());
                isiKomentarTglKota(dtp.Rows[0]["id_plotting_eval_pembahasan"].ToString(), idPersonalReviewer);
            }
        }
        ...
        {
            DataTable dt = new DataTable();
            objMdlPdfusulanBaru.ListRekapRabPerThn(ref dt, pIdUsulanKegiatan);
        ...
        private void isiHasilEvaluasiUsulan(string pIdPlotting)
        {
            ...
            objModel.getPenilaianUsulanPdfPembahasan(ref dt, Guid.Parse(pIdPlotting));
            //objMdlPdfusulanBaru.ListDanaMitra(ref dt, pIdUsulanKegiatan);
