...
{
    public partial class hasilPenilaianPembahasan : System.Web.UI.UserControl
    {
        ...
        protected byte[] GeneratePDF(string idUsulanKegiatan, string idPersonalReviewer)
        {
            ...
            {
                Server.Execute(String.Format("~/UserControls/Reviewer/report/hasilPenilaianPembahasan.aspx?id_usulan_kegiatan={0}&id_personal_reviewer={1}",
