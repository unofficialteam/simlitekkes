<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="evaluasiAdministrasi.ascx.cs" Inherits="simlitekkes.UserControls.Reviewer.evaluasiAdministrasi" %>
                    ...
                    <div class="col-sm-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Evaluasi Dokumen (Administrasi)</h3>
                                <div class="row mb-4">
                                    <div class="col-sm-12">
