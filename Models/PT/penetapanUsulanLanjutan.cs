...
{
    public class penetapanUsulanLajutan : _abstractModels
    {
        public penetapanUsulanLajutan()
        {
            this.setInitValues();
        }
        ...
        public bool getTotalRekapSkema(ref DataTable dataTable, string kd_program_hibah,
            string thn_pelaksanaan_kegiatan, Guid id_institusi)
        {
            ...
            string strSQL = $"SELECT COALESCE(SUM(jml_usulan),0::INTEGER) AS total_jml_usulan, " +
                ...
                $"FROM hibah.list_rekap_skema_penetapan_pemenang_usulan_lanjutan_opt_pt('{kd_program_hibah}', " +
                $"'{thn_pelaksanaan_kegiatan}', '{id_institusi}');";
            ...
            string thn_pelaksanaan_kegiatan, Guid id_institusi)
        {
            ...
            string strSQL = $"SELECT * FROM hibah.list_rekap_skema_penetapan_pemenang_usulan_lanjutan_opt_pt('{kd_program_hibah}', " +
                $"'{thn_pelaksanaan_kegiatan}', '{id_institusi}');";
        ...
        public bool getJmlDataPenetapan(string thn_pelaksanaan_kegiatan, 
            ...
            int limit, int offset)
        {
            ...
            string strSQL = $"SELECT count(*)::int AS jml_data " +
                $"FROM hibah.list_penetapan_pemenang_usulan_lajutan_opt_pt( " +
                $"'{thn_pelaksanaan_kegiatan}', '{id_institusi}', " +
            ...
            int limit, int offset)
        {
            ...
            string strSQL = $"SELECT * FROM hibah.list_penetapan_pemenang_usulan_lajutan_opt_pt( " +
                $"'{thn_pelaksanaan_kegiatan}', '{id_institusi}', " +
                $"{id_skema}, '{nama}', '{sts_penetapan}', {limit}, {offset});";
            ...
            int limit, int offset)
        {
            ...
            string strSQL = $"SELECT COUNT(*)::int AS jml_data " +
                $"FROM hibah.list_penetapan_pemenang_usulan_lajutan_opt_pt(" +
                $"'{thn_pelaksanaan_kegiatan}', '{id_institusi}', " +
                $"{id_skema}, '{nama}', '{sts_penetapan}', {limit}, {offset}) WHERE kd_sts_penetapan_pemenang = '9';";
        ...
        public bool setSimpanPermanen(string thn_pelaksanaan_kegiatan,
            Guid id_institusi, int id_skema)
        {
            string strSQL = $@"SELECT * FROM hibah.set_permanen_penetapan_usulan_lanjutan_opt_pt('{thn_pelaksanaan_kegiatan}', 
                            '{id_institusi}', {id_skema});";
            bool isSuccess = _db.ExecuteNonQuery(strSQL);
            if (!isSuccess)
                this._errorMessage = this._db.ErrorMessage;
            ...
            int limit, int offset)
        {
            ...
            string strSQL = $"SELECT COUNT(*)::int AS jml_data " +
               $"FROM hibah.list_penetapan_pemenang_usulan_lajutan_opt_pt(" +
                $"'{thn_pelaksanaan_kegiatan}', '{id_institusi}', " +
                $"{id_skema}, '{nama}', '{sts_penetapan}', {limit}, {offset}) WHERE kd_sts_permanen = '1';";
            ...
            int limit, int offset)
        {
            ...
            string strSQL = $"SELECT nidn, nama, judul, nama_skema, kd_perguruan_tinggi, nama_institusi, " +
                ...
                $"FROM hibah.list_penetapan_pemenang_usulan_lajutan_opt_pt( " +
                $"'{thn_pelaksanaan_kegiatan}', '{id_institusi}', {id_skema}, '{nama}', '{sts_penetapan}', {limit}, {offset});";
