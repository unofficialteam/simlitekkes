...
{
    public class penetapanUsulanBaruAbdimas : _abstractModels
    {
        public penetapanUsulanBaruAbdimas()
        {
            this.setInitValues();
        }
            ...
            int limit, int offset)
        {
            ...
            string strSQL = $"SELECT count(*)::int AS jml_data " +
                $"FROM hibah.list_penetapan_pemenang_usulan_baru_abdimas_opt_pt('{thn_usulan_kegiatan}', " +
            ...
            int limit, int offset)
        {
            ...
            string strSQL = $"SELECT * FROM hibah.list_penetapan_pemenang_usulan_baru_abdimas_opt_pt('{thn_usulan_kegiatan}', " +
                $"'{thn_pelaksanaan_kegiatan}', '{kd_tahapan_kegiatan}', '{id_institusi}', " +
                $"{id_skema}, '{nama}', '{sts_penetapan}', {limit}, {offset});";
