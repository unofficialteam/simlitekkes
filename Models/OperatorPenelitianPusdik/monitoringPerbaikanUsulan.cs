...
namespace simlitekkes.Models.OperatorPenelitianPusdik
{
    public class monitoringPerbaikanUsulan : _abstractModels
    {
        ...
        public bool listRekapSkema(ref DataTable dataTable, string thn_pelaksanaan_kegiatan, string kd_jenis_kegiatan)
        {
            bool isSuccess = false;

            string strSQL = $"SELECT * FROM hibah.list_rekap_skema_perbaikan_usulan_opt_ppsdm('{thn_pelaksanaan_kegiatan}', " +
                $"'{kd_jenis_kegiatan}');";
        ...
        public bool getJmlPerbaikanUsulan(string thn_pelaksanaan_kegiatan, int id_skema, 
            string kd_sts_pelaksanaan, string nama, int limit, int offset)
        {
            bool isSuccess = false;

            string strSQL = $"SELECT count(*)::int AS jml_data " +
                $"FROM hibah.list_monitoring_perbaikan_usulan_opt_ppsdm('{thn_pelaksanaan_kegiatan}', " +
        ...
        public bool listDaftarPerbaikanUsulan(ref DataTable dataTable, string thn_pelaksanaan_kegiatan, int id_skema, 
            string kd_sts_pelaksanaan, string nama, int limit, int offset)
        {
            bool isSuccess = false;

            string strSQL = $"SELECT * FROM hibah.list_monitoring_perbaikan_usulan_opt_ppsdm('{thn_pelaksanaan_kegiatan}', " +
                $"{id_skema}, '{kd_sts_pelaksanaan}', '{nama}',  {limit}, {offset});";
        ...
        public bool updatePerbaikanUsulan(Guid idTransaksiKegiatan)
        {
            bool isSuccess = false;

            string strSQL = $"SELECT * FROM hibah.update_sts_pelaksanaan_perbaikan_usulan('{idTransaksiKegiatan}');";
        ...
        public bool getExcelPerbaikanUsulan(ref DataTable dataTable, string thn_pelaksanaan_kegiatan, int id_skema)
        {
            bool isSuccess = false;

            string strSQL = $"SELECT nidn, nama, judul, nama_singkat_skema, kd_perguruan_tinggi, " +
                $"nama_institusi, sts_pelaksanaan, tahun_ke " +
                $"FROM hibah.list_monitoring_perbaikan_usulan_opt_ppsdm('{thn_pelaksanaan_kegiatan}', {id_skema});";
