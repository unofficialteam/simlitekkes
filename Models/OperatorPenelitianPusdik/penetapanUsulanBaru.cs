    ...
    public class penetapanUsulanBaru : _abstractModels
    {
            ...
            string thn_pelaksanaan_kegiatan, string kd_tahapan_kegiatan)
        {
            ...
            string strSQL = $"SELECT COALESCE(SUM(jml_usulan),0::INTEGER) AS total_jml_usulan, " +
                ...
                $"FROM hibah.rekap_skema_list_penetapan_pemenang_usulan_baru_opt_ppsdm('{kd_program_hibah}', " +
            ...
            string thn_pelaksanaan_kegiatan, string kd_tahapan_kegiatan)
        {
            ...
            string strSQL = $"SELECT * FROM hibah.rekap_skema_list_penetapan_pemenang_usulan_baru_opt_ppsdm('{kd_program_hibah}', " +
                $"'{thn_usulan_kegiatan}', '{thn_pelaksanaan_kegiatan}', '{kd_tahapan_kegiatan}');";
            ...
            int limit, int offset)
        {
            ...
            string strSQL = $"SELECT count(*)::int AS jml_data " +
                $"FROM hibah.list_penetapan_pemenang_usulan_baru_opt_ppsdm_by_institusi('{thn_usulan_kegiatan}', " +
            ...
            int limit, int offset)
        {
            ...
            string strSQL = $"SELECT * FROM hibah.list_penetapan_pemenang_usulan_baru_opt_ppsdm_by_institusi('{thn_usulan_kegiatan}', " +
                $"'{thn_pelaksanaan_kegiatan}', '{kd_tahapan_kegiatan}', '{id_institusi}', " +
                $"{id_skema}, '{nama}', '{sts_penetapan}', {limit}, {offset});";
        ...
        public bool cekPermanenPenetapan(ref DataTable dataTable, string thn_usulan_kegiatan, string thn_pelaksanaan_kegiatan,
            string kd_tahapan_kegiatan, Guid id_institusi, int id_skema, string nama, string sts_penetapan,
            int limit, int offset)
        {
            bool isSuccess = false;
        ...
        public bool setSimpanPermanen(string thn_usulan_kegiatan, string thn_pelaksanaan_kegiatan,
            string kd_tahapan_kegiatan, Guid id_institusi, int id_skema)
        {
            string strSQL = $@"SELECT * FROM hibah.set_permanen_penetapan_usulan_baru_opt_ppsdm('{thn_usulan_kegiatan}', 
        ...
        public bool setBukaPermanen(string thn_usulan_kegiatan, string thn_pelaksanaan_kegiatan,
            string kd_tahapan_kegiatan, Guid id_institusi, int id_skema)
        {
            string strSQL = $@"SELECT * FROM hibah.set_buka_permanen_penetapan_usulan_baru_opt_ppsdm('{thn_usulan_kegiatan}', 
                                '{thn_pelaksanaan_kegiatan}', '{kd_tahapan_kegiatan}', '{id_institusi}', {id_skema});";
            bool isSuccess = _db.ExecuteNonQuery(strSQL);
            if (!isSuccess)
                this._errorMessage = this._db.ErrorMessage;
